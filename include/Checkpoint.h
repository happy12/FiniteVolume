...
//   12      4     equation tag (uint32_t): 0 = Diffusion, 1 = Euler, 2 = AdvectionDiffusion, 3 = NavierStokes, 4 = RANS
...
//                 RANS:                            cell_count EulerState structs, immediately followed by
//                                                   cell_count doubles (nut) -- RANSFVMSolver's mean-flow
...
// not archive results long-term. RANS's dual-payload layout above did NOT
...
namespace Checkpoint {
    ...
    // RANS overload: writes U immediately followed by nut (see the dual-payload
    ...
    // RANS overload: reads U immediately followed by nut (see the dual-payload
